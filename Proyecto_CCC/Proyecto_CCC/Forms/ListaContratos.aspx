<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Forms/Home.Master" CodeBehind="ListaContratos.aspx.vb" Inherits="Proyecto_CCC.ListaContratos" %>
     ...
     <div class=" container-fluid align-items-center" > 
        <div class="row">
            <div class="col-lg-12 ">
                   ...
                   <br />
                        <h3 style="font-size: x-large; font-weight: bold; font-style: normal">Lista de Contratos </h3> 
                ...
                <asp:DropDownList CssClass="dropdown form-control-sm border-success" ID="Cmb_ListaContratos" runat="server" AutoPostBack="True">
