Public Class Promociones
    ...
    Protected Sub btnIngresar_Click(sender As Object, e As EventArgs) Handles btnIngresar.Click
        ...
        If FechaInicio > Date.Today And FechaFin > FechaInicio Then
            Consulta("INSERT INTO `sql3221722`.`promociones` (`nombre`, `fecha-inicio`, `fecha-fin`, `descuento`, `restriccion`, `descripcion`) VALUES ('" & Txtnombreprom.Text & "', '" & Txtfechainicio.Text & "', '" & Txtfechafin.Text & "', '" & TxtDescuento.Text & "', '" & txtAplicadesde.Text & "', '" & TxtDescuento.Text & "');")
