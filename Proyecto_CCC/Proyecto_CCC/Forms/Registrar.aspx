  ...
  <div class="row">
    ...
    <div class="texto col-lg-12"> 
       ...
       <div class="col-lg-3"> <h6 class=" float-right" > Teléfono: </h6> </div>
        <div class="col-lg-6 float-left">  
        <asp:TextBox ID="TxtTelefono" CssClass="border-success rounded form-control form-control-sm" PlaceHolder="2354-8545"  onkeypress="return soloLetras(event)" MaxLength="8" runat="server"> </asp:TextBox>
    </div></div></div>
      ...
      <div class="texto col-lg-12"> 
       ...
       <div class="col-lg-3"> <h6 class=" float-right" > NIT: </h6> </div>
        <div class="col-lg-6 float-left"> 
        <asp:TextBox ID="TxtNIT" CssClass="border-success rounded form-control form-control-sm" PlaceHolder="1921010981202"  onkeypress="return soloLetras(event)" MaxLength="14" runat="server"> </asp:TextBox>
    </div></div></div>
       ...
       <div class="col-lg-3"> <h6 class=" float-right" > NRC: </h6> </div>
        <div class="col-lg-6 float-left"> 
        <asp:TextBox ID="TxtRNC" CssClass="border-success rounded form-control form-control-sm" PlaceHolder="1921010981202"  onkeypress="return soloLetras(event)" MaxLength="17" runat="server"> </asp:TextBox>
    </div></div></div>
  ...
  <div class="texto col-lg-12"> 
       ...
       <div class="col-lg-3"> <h6 class=" float-right" > Monto total: </h6> </div>
        ...
        <asp:TextBox ID="txtmonto" CssClass="border-success rounded form-control form-control-sm" PlaceHolder="$"  onkeypress="return soloLetras(event)"  MaxLength="6" runat="server" > </asp:TextBox>
            <asp:RangeValidator ID="rgvMontoCliente" runat="server" Display="Dynamic" ControlToValidate="txtmonto"  ForeColor="Red" ErrorMessage="Monto fuera de rango" Type="Double" MaximumValue="10000" MinimumValue="50"></asp:RangeValidator>
    </div></div></div>
     ...
     <div class="texto col-lg-12"> 
       ...
       <div class="texto col-lg-12" style="margin-bottom: 10%; "> 
           <asp:Button ID="BtnInsertar" CssClass="btn-group-sm btn-success btn-sm" runat="server" Text="Registrar" />
        </div>
</div>
           </div>
    <div style="overflow:auto; padding:1%">
      ...
      <asp:Button ID="btnCancelar" Width="100"  Height="38" CssClass="btn-group-sm btn-success btn-sm" runat="server" Text="Cancelar" />
