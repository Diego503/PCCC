...
<div id="regForm" class="container-fluid" style="overflow:auto; background-color:#FAFAFA; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" >
  ...
  <h3 class="btn-group-sm btn-success text-center  rounded" style="padding:1%"> REGISTRO DE NUEVO CLIENTE</h3>
  ...
  <div class="tab"> 
   <h4 class="text-center"> <strong> 1.- INGRESE LOS DATOS DEL CLIENTE  </strong> </h4>
  <div class="row">
    <div class="col-sm-7 ">
